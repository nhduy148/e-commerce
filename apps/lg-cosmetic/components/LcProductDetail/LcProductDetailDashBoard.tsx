...
const LcProductDetailDashBoardComponent = ({ product }: Props) => {
  ...
  return (
    <Box>
      ...
      >
        <Typography variant="title" textTransform="uppercase" color="primary">
          {pageContent.detail}
        </Typography>
      </Box>
      <Box>
...
export const LcProductDetailDashBoard = memo(
  LcProductDetailDashBoardComponent,
  isEqual,
);
