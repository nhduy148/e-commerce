...
interface INesIconButtonProps extends IconButtonProps {
  active?: boolean;
  iconName?: string;
  iconColor?:
    | "inherit"
...
const NesIconButtonComponent = (props: INesIconButtonProps) => {
  const {
    active,
    iconName,
    iconColor,
...
export const NesIconButton = memo(NesIconButtonComponent, isEqual);
