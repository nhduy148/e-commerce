...
import { BlogSubCard } from "./NesBlogSubCard";
...
const NesBlogLiveStyleComponent = ({ isPC, data }: Props) => {
...
export const NesBlogLiveStyle = memo(NesBlogLiveStyleComponent, isEqual);
