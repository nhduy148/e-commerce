...
import { BlogCard } from "./NesBlogCard";
...
const NesBlogBeautyTipsComponent = ({ isPC, data }: Props) => {
...
export const NesBlogBeautyTips = memo(NesBlogBeautyTipsComponent, isEqual);
